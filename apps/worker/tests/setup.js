...
exports.mockTwitterResponse = exports.mockDexScreenerResponse = exports.waitFor = exports.createMockJobData = exports.createMockSignal = exports.createMockSocialMetrics = exports.createMockTokenMetrics = exports.createMockToken = void 0;
...
afterEach(async () => {
    ...
    try {
        if (process.env.DATABASE_URL?.includes('test')) {
            await database_1.db.signal.deleteMany({});
            await database_1.db.tokenMetrics.deleteMany({});
            await database_1.db.socialMetrics.deleteMany({});
            await database_1.db.technicalAnalysis.deleteMany({});
            await database_1.db.aiAnalysis.deleteMany({});
            await database_1.db.jobLog.deleteMany({});
            await database_1.db.healthMetric.deleteMany({});
            await database_1.db.token.deleteMany({});
        }
    }
    catch (error) {
    }
...
const createMockTokenMetrics = (overrides = {}) => ({
    id: 'test-metrics-id',
...
exports.createMockTokenMetrics = createMockTokenMetrics;
const createMockSocialMetrics = (overrides = {}) => ({
    id: 'test-social-id',
    tokenAddress: '0x1234567890123456789012345678901234567890',
    platform: 'twitter',
    mentions: 100,
...
exports.createMockSocialMetrics = createMockSocialMetrics;
...
exports.createMockSignal = createMockSignal;
...
exports.createMockJobData = createMockJobData;
const waitFor = (ms) => new Promise(resolve => setTimeout(resolve, ms));
exports.waitFor = waitFor;
exports.mockDexScreenerResponse = {
    pairs: [
        {
            chainId: 'ethereum',
            dexId: 'uniswap',
